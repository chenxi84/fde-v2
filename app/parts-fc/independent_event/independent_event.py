...
class IndependentEvent:
    ...
    def _init_db(self):
        self.db.execute("""CREATE TABLE IF NOT EXISTS independent_event (
        ...
        self.db.execute("""CREATE INDEX IF NOT EXISTS idx_ie_part_no ON independent_event (part_no);""")
        self.db.execute("""CREATE INDEX IF NOT EXISTS idx_ie_status ON independent_event (status);""")
        self.db.execute("""CREATE INDEX IF NOT EXISTS idx_ie_period ON independent_event (period);""")
        self.db.execute("""CREATE INDEX IF NOT EXISTS idx_ie_bp_batch ON independent_event (bp_batch);""")
    ...
    def create(self, event_type: str, part_no: str, period: str, event_qty: float,
        ...
        creator = self.ctx.get("userno", "系统") if hasattr(self, "ctx") else "系统"
    ...
    def list(self, part_no: str = None, event_type: str = None,
             status: str = None, period: str = None, page: int = None, size: int = None):
        """按条件列表查询。"""
