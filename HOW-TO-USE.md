...
> 本文件是「快速上手 / 部署」操作手册。平台的**核心设计、架构、应用约定、九步法、测试红线**等完整说明见 [`README.md`](README.md)。
>
> **给 AI 代理（Claude Code / Workbuddy 等）**：开工前请先读 [`AGENTS.md`](AGENTS.md)（项目约定与关键规矩，尤其「数据操作必须走 MCP 工具、禁止直接写脚本插库」）。
